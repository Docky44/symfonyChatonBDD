...
class ChatonsController extends AbstractController
{
    ...
    {
        //Aller chercher les chatons dans la base
    ...
    public function modifier($id, ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $chaton = $doctrine->getRepository(Chaton::class)->find($id); // select * from chaton where id = ...
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //et on dit à l'entity manager de mettre le chaton en question dans la table
            $em->persist(($chaton));
